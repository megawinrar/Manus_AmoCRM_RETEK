...
STATUS_NOTE_TEMPLATES = {
    ...
    "TO_ARCHIVE": (
        ...
        "  — «Дата возврата из архива»: если нужно вернуться позже (если не указать — сделка останется в архиве навсегда)\n\n"
        ...
        "⏰ Микросервис перенесёт сделку в архивную воронку ночью (если все поля заполнены)."
    ),
}
